...
const GROUPS: GroupConfig[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: "Pdir", label: "Ativa", description: "Potência ativa ", unit: "W" },
      { key: "Prev", label: "Reversa", description: "Potência reversa", unit: "W" },
      { key: "Q", label: "Reativa", description: "Potência reativa", unit: "Var" },
      { key: "S", label: "Aparente", description: "Potência aparente", unit: "VA" },
